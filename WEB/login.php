<?php
	...
	if(isset($_POST["anmelden"])){
		...
		$ausgabe = "<!doctype html><html lang='de'><head><!-- Required meta tags --><meta charset='utf-8'><meta name='viewport' content='width=device-width, initial-scale=1, shrink-to-fit=no'>
		...
		<title>Log in</title><link rel='shortcut icon' href='IMG/favicon.png' type='<mime-type>' />
		</head>";
		$ausgabe .= "<body style='background-color: #eeeeee'>
		<!-- Optional JavaScript -->
